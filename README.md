...
4.  **Configure environment variables:**
    ...
    GROQ_API_KEY="your_groq_api_key" Gotten from [Groq](https://groq.com/)
    TAVILY_API_KEY="your_tavily_api_key" Gotten from [Tavily](https://tavily.com/)

    # --- Email Service (Via [Zoho](https://www.zoho.com)
